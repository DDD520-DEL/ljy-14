import { Team, Song, TeamComment, TeamPost, TeamVideo, TeamPhoto, EncyclopediaArticle, TeamActivity, Recruitment } from '../../shared/types.js';
...
export const mockRecruitments: Recruitment[] = [
  {
    ...
    teamId: 1,
    title: '朝阳红扇舞蹈队春季招新',
    description: '我们是一支充满活力的红扇舞团队，多次参加区里演出获奖。现面向社会招纳新队员，无论你有无基础，只要热爱舞蹈，欢迎加入我们！',
    recruitCount: 10,
    minAge: 40,
    maxAge: 65,
    gender: 'female',
    ...
    contactWechat: 'wangguilan888',
    requirements: '身体健康，热爱舞蹈，能坚持参加日常排练',
    benefits: '免费教学，参加演出机会，团队活动丰富',
    status: 'active',
  ...
  },
  {
    ...
    teamId: 2,
    title: '海淀炫舞团招新啦！',
    description: '紧跟潮流的炫舞团招募新成员！擅长编排流行广场舞，每周学习新动作。年轻的心态，时尚的舞步，等你来加入！',
    recruitCount: 8,
    minAge: 30,
    maxAge: 55,
    gender: 'any',
    ...
    contactWechat: '炫舞团李团长',
    requirements: '喜欢流行音乐，有一定节奏感',
    benefits: '年轻活力的团队氛围，经常参加比赛和演出',
    status: 'active',
    createdAt: '2026-06-12T14:30:00Z',
  ...
  },
  {
    ...
    teamId: 3,
    title: '茉莉花开舞队诚邀新成员',
    description: '以古典舞和民族舞为特色的舞队，追求艺术品质，传承中华文化。欢迎有舞蹈基础或热爱古典艺术的朋友加入。',
    recruitCount: 5,
    minAge: 35,
    maxAge: 60,
    gender: 'female',
    ...
    contactWechat: 'molihuakai',
    requirements: '有一定舞蹈基础优先，仪态端庄',
    benefits: '专业老师指导，参加各类文艺演出',
    status: 'active',
  ...
  },
  {
    ...
    teamId: 4,
    title: '西城活力健身队扩招',
    description: '以健身操和动感舞蹈为主的队伍，注重锻炼身体，健康快乐。适合各个年龄段，零基础也能快速上手！',
    recruitCount: 15,
    minAge: 25,
    maxAge: 70,
    gender: 'any',
    ...
    contactWechat: 'huoli_lsj',
    requirements: '身体健康，热爱运动，能坚持晨练',
    benefits: '科学健身指导，每月团建活动',
    status: 'active',
    createdAt: '2026-06-14T07:45:00Z',
    updatedAt: '2026-06-14T07:45:00Z'
  },
  {
    id: 5,
    teamId: 5,
    title: '爵士辣妈队寻找新辣妈',
    description: '一群热爱爵士舞的辣妈组成的队伍，性感又不失优雅。如果你也想通过舞蹈展现自信与魅力，快来加入我们！',
    recruitCount: 6,
    minAge: 28,
    maxAge: 45,
    gender: 'female',
    ...
    contactWechat: 'jazz_lama',
    requirements: '喜欢爵士舞，有一定节奏感，形象气质佳',
    benefits: '专业爵士舞培训，商演机会多，辣妈圈子资源',
    status: 'active',
  ...
  },
  {
    ...
    teamId: 6,
    title: '夕阳红舞队欢迎退休朋友',
    description: '夕阳无限好，跳舞更妖娆。我们是一群热爱生活的退休老人，用舞蹈展现夕阳的美丽。欢迎退休的朋友们加入！',
    recruitCount: 12,
    minAge: 55,
    maxAge: 75,
    gender: 'any',
    ...
    contactWechat: 'zhaojinfeng666',
    requirements: '已退休，身体健康，热爱跳舞',
    benefits: '丰富退休生活，结交志同道合的朋友，定期出游活动',
    status: 'active',
  ...
  },
  {
    ...
    teamId: 8,
    title: '蒙古风情舞队招新',
    description: '独具特色的蒙古族舞蹈队，盅碗舞、筷子舞是我们的拿手好戏！如果你喜欢草原文化，想学习独特的民族舞蹈，欢迎加入！',
    recruitCount: 4,
    minAge: 30,
    maxAge: 55,
    gender: 'any',
    ...
    contactWechat: 'mengguwu_dao',
    requirements: '热爱民族舞蹈，能吃苦耐劳',
    benefits: '正宗蒙古舞教学，参加民族文化交流活动',
    status: 'active',
  ...
  },
  {
    ...
    teamId: 9,
    title: '大兴秧歌队招新',
    description: '历史悠久的传统秧歌队，传承非遗文化。扭秧歌，闹喜庆，强身健体又开心！欢迎喜欢传统文化的朋友加入。',
    recruitCount: 10,
    minAge: 45,
    maxAge: 70,
    gender: 'any',
    ...
    contactWechat: 'yangge_daxing',
    requirements: '喜欢传统艺术，能坚持排练',
    benefits: '学习传统秧歌技艺，参加春节庙会等文化活动',
    status: 'active',
